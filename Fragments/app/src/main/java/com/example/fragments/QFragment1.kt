 ...
 * Use the [QFragment1.newInstance] factory method to
 * create an instance of this fragment.
 */
class QFragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        sharedViewModel.setSelectedValue("Hello from Fragment1")
    ...
    companion object {
         ...
         * @return A new instance of fragment QFragment1.
         */
